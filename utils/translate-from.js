function replaceFrom(str) {
	return str
		...
		.replaceAll(/(̄|Ԉ̄|Ꝇ̄|Ƛ̄|Ꟛ̄)/gu, 'Лл')
		.replaceAll(/(̄|ԉ̄|ꝇ̄|ƛ̄|ꟛ̄)/gu, 'лл')
		...
		.replaceAll(/[ѢꙘЪЭ]/gu, 'Е')
		.replaceAll(/[ѣꙙъэ]/gu, 'е')

		.replaceAll(/(Ꙓ|Ꙝ|Ъ̈|Э̆)/gu, 'Є')
		.replaceAll(/(ꙓ|ꙝ|ъ̈|э̆)/gu, 'є')
