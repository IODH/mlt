...
function replaceTo(str) {
	return str
		...
		.replaceAll(/О(кр|хр)/gu, (_, group) => '' + group)
		.replaceAll(/о(кр|хр)/gu, (_, group) => '' + group)

		.replaceAll(/[Пп]ок/gu, (m) => 'Ꚛ' + m[1] + m[2])
		.replaceAll('Ок', (m) => 'Ꚛ' + m[1])
		.replaceAll('ок', (m) => 'ꚛ' + m[1])
		...
		.replaceAll(/Ию[лчжшщ]/gu, (m) => 'Ы̄' + m[2])
		.replaceAll(/Ӥ[лчжшщ]/gu, (m) => 'Ӹ' + m[1])
		.replaceAll(/Иє[лчжшщ]/gu, (m) => 'Ы̆' + m[2])

		.replaceAll(/ию[лчжшщ]/gu, (m) => 'ы̄' + m[2])
		.replaceAll(/ӥ[лчжшщ]/gu, (m) => 'ӹ' + m[1])
		.replaceAll(/иє[лчжшщ]/gu, (m) => 'ы̆' + m[2])

		.replaceAll(/[лчжшщЛЧЖШЩ]ию/gu, (m) => m[0] + 'ы̄')
		.replaceAll(/[лчжшщЛЧЖШЩ]ӥ/gu, (m) => m[0] + 'ӹ')
		.replaceAll(/[лчжшщЛЧЖШЩ]иє/gu, (m) => m[0] + 'ы̆')
		...
		.replaceAll(/[бпвмфБПВМФ]/gu, (m) => m[0] + '')
		.replaceAll(/[бпвмфБПВМФ]о/gu, (m) => m[0] + 'ѡ')
		...
		.replaceAll(/[бвмфБВМФ]ҍі/gu, (m) => m[0] + 'ҍɨ')
		.replaceAll(/[бпвмфБПВМФ]ҍ/gu, (m) => m[0] + 'ҍꙗ') //  
		...
		.replaceAll(/Ӓ[бпвмф]/gu, (m) => 'Ӛ' + m[1])

		.replaceAll(/[бвпмф]/gu, (m) => 'Ꙗ' + m[1])
		.replaceAll(/І[бвмф]/gu, (m) => 'Ɨ' + m[1])
